...
package proyecto_bi.carga_mysql_0_1;
...
/**
 * Job: carga_mysql Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class carga_mysql implements TalendJob {
	...
	private final String jobName = "carga_mysql";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(carga_mysql.this, new Object[] { e,
	...
	public static class salidaStruct implements
		...
		final static byte[] commonByteArrayLock_PROYECTO_BI_carga_mysql = new byte[0];
		static byte[] commonByteArray_PROYECTO_BI_carga_mysql = new byte[0];
		...
		public Integer rucDni;

		public Integer getRucDni() {
			return this.rucDni;
		}
		...
		public Integer monedaLinea;

		public Integer getMonedaLinea() {
			return this.monedaLinea;
		}

		public BigDecimal lineaCredito;
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + (int) this.persona;
		...
		public void copyDataTo(salidaStruct other) {
			...
			other.telefono1 = this.telefono1;
			other.telefono2 = this.telefono2;
			other.monedaLinea = this.monedaLinea;
			other.lineaCredito = this.lineaCredito;
			other.codigoAuxiliar = this.codigoAuxiliar;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROYECTO_BI_carga_mysql.length) {
					if (length < 1024
							&& commonByteArray_PROYECTO_BI_carga_mysql.length == 0) {
						commonByteArray_PROYECTO_BI_carga_mysql = new byte[1024];
					} else {
						commonByteArray_PROYECTO_BI_carga_mysql = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROYECTO_BI_carga_mysql, 0,
						length);
				strReturn = new String(commonByteArray_PROYECTO_BI_carga_mysql,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROYECTO_BI_carga_mysql) {
				...
				try {
					...
					this.rucDni = readInteger(dis);

					this.telefono1 = readInteger(dis);

					this.telefono2 = readInteger(dis);

					this.monedaLinea = readInteger(dis);

					this.lineaCredito = (BigDecimal) dis.readObject();

					this.codigoAuxiliar = readString(dis);
					...
					this.tipoDocumento = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.rucDni, dos);

				// Integer

				writeInteger(this.telefono1, dos);

				// Integer

				writeInteger(this.telefono2, dos);

				// Integer

				writeInteger(this.monedaLinea, dos);

				// BigDecimal

				dos.writeObject(this.lineaCredito);

				// String

				writeString(this.codigoAuxiliar, dos);
				...
				writeInteger(this.tipoDocumento, dos);
		...
		public String toString() {
			...
			sb.append(",rucDni=" + String.valueOf(rucDni));
			sb.append(",telefono1=" + String.valueOf(telefono1));
			sb.append(",telefono2=" + String.valueOf(telefono2));
			sb.append(",monedaLinea=" + String.valueOf(monedaLinea));
			sb.append(",lineaCredito=" + String.valueOf(lineaCredito));
			sb.append(",codigoAuxiliar=" + codigoAuxiliar);
			sb.append(",estado=" + String.valueOf(estado));
			sb.append(",departamento=" + departamento);
			sb.append(",ubigeo=" + ubigeo);
			sb.append(",tipoDocumento=" + String.valueOf(tipoDocumento));
			sb.append(",apellidoPaterno=" + apellidoPaterno);
			sb.append(",apellidoMaterno=" + apellidoMaterno);
			sb.append(",nombre=" + nombre);
			sb.append(",canalId=" + String.valueOf(canalId));
			sb.append("]");
		...
		public int compareTo(salidaStruct other) {
			...
			returnValue = checkNullsAndCompare(this.persona, other.persona);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tDBOutput_3 = "persona";
				...
				if (dbProperties_tDBOutput_3 == null
					...
					url_tDBOutput_3 = "jdbc:mysql://"
							+ "ljc-mysql-5-7-22.cr3ouljqsrq9.us-east-2.rds.amazonaws.com"
							+ ":" + "3306" + "/" + "retail_bd" + "?"
				...
				String dbUser_tDBOutput_3 = "castillo";

				final String decryptedPassword_tDBOutput_3 = routines.system.PasswordEncryptUtil
						.decryptPassword("a505bb2270750a38ad301b0df5a063e4");
				...
				java.sql.DatabaseMetaData dbMetaData_tDBOutput_3 = conn_tDBOutput_3
						.getMetaData();
				java.sql.ResultSet rsTable_tDBOutput_3 = dbMetaData_tDBOutput_3
				...
				while (rsTable_tDBOutput_3.next()) {
					...
					if (table_tDBOutput_3.equalsIgnoreCase("persona")) {
						whetherExist_tDBOutput_3 = true;
						break;
					}
				}
				rsTable_tDBOutput_3.close();
				...
				stmtCreate_tDBOutput_3
						.execute("CREATE TABLE `"
								+ tableName_tDBOutput_3
								+ "`(`persona` INT(10)   not null ,`codigo` VARCHAR(45)   not null ,`razonSocial` VARCHAR(45)  ,`direccion` VARCHAR(100)  ,`rucDni` INT(10)  ,`telefono1` INT(10)  ,`telefono2` INT(10)  ,`monedaLinea` INT(10)  ,`lineaCredito` DECIMAL(10,0)  ,`codigoAuxiliar` VARCHAR(45)  ,`estado` INT(10)  ,`departamento` VARCHAR(45)  ,`ubigeo` VARCHAR(45)  ,`tipoDocumento` INT(10)  ,`apellidoPaterno` VARCHAR(45)  ,`apellidoMaterno` VARCHAR(45)  ,`nombre` VARCHAR(220)  ,`canalId` INT(10)  ,primary key(`persona`))");
				stmtCreate_tDBOutput_3.close();

				String insert_tDBOutput_3 = "INSERT INTO `"
						+ "persona"
						+ "` (`persona`,`codigo`,`razonSocial`,`direccion`,`rucDni`,`telefono1`,`telefono2`,`monedaLinea`,`lineaCredito`,`codigoAuxiliar`,`estado`,`departamento`,`ubigeo`,`tipoDocumento`,`apellidoPaterno`,`apellidoMaterno`,`nombre`,`canalId`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
				...
				String dbUser_tDBInput_2 = "azure";
				...
				String dbname_tDBInput_2 = "RETAIL";
				...
				String dbquery_tDBInput_2 = "select * from ma.persona;";
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							if (rs_tDBInput_2.getObject(1) != null) {
								row1.persona = rs_tDBInput_2.getInt(1);
							} else {
						...
						if (colQtyInRs_tDBInput_2 < 2) {
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2
									...
									row1.codigo = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row1.codigo = tmpContent_tDBInput_2;
								}
							} else {
								row1.codigo = null;
							}
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2
										.contains(rsmd_tDBInput_2
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row1.razonSocial = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row1.razonSocial = tmpContent_tDBInput_2;
								}
							} else {
								row1.razonSocial = null;
							}
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2
										.contains(rsmd_tDBInput_2
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row1.direccion = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row1.direccion = tmpContent_tDBInput_2;
								}
							} else {
								row1.direccion = null;
							}
						...
						if (colQtyInRs_tDBInput_2 < 5) {
							...
							if (rs_tDBInput_2.getObject(5) != null) {
								row1.rucDni = rs_tDBInput_2.getInt(5);
							} else {
								row1.rucDni = null;
							}
						}
						if (colQtyInRs_tDBInput_2 < 6) {
							...
							if (rs_tDBInput_2.getObject(6) != null) {
								row1.telefono1 = rs_tDBInput_2.getInt(6);
							} else {
								row1.telefono1 = null;
							}
						}
						if (colQtyInRs_tDBInput_2 < 7) {
							...
							if (rs_tDBInput_2.getObject(7) != null) {
								row1.telefono2 = rs_tDBInput_2.getInt(7);
							} else {
								row1.telefono2 = null;
							}
						}
						if (colQtyInRs_tDBInput_2 < 8) {
							row1.monedaLinea = null;
						} else {

							if (rs_tDBInput_2.getObject(8) != null) {
								row1.monedaLinea = rs_tDBInput_2.getInt(8);
							} else {
								row1.monedaLinea = null;
							}
						}
						if (colQtyInRs_tDBInput_2 < 9) {
							row1.lineaCredito = null;
						} else {

							if (rs_tDBInput_2.getObject(9) != null) {
								row1.lineaCredito = rs_tDBInput_2
										.getBigDecimal(9);
							} else {
								row1.lineaCredito = null;
							}
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2
										.contains(rsmd_tDBInput_2
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row1.codigoAuxiliar = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row1.codigoAuxiliar = tmpContent_tDBInput_2;
								}
							} else {
								row1.codigoAuxiliar = null;
							}
						...
						if (colQtyInRs_tDBInput_2 < 11) {
							...
							if (rs_tDBInput_2.getObject(11) != null) {
								row1.estado = rs_tDBInput_2.getInt(11);
							} else {
								row1.estado = null;
							}
						}
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2
										.contains(rsmd_tDBInput_2
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row1.departamento = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row1.departamento = tmpContent_tDBInput_2;
								}
							} else {
								row1.departamento = null;
							}
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2
										.contains(rsmd_tDBInput_2
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row1.ubigeo = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row1.ubigeo = tmpContent_tDBInput_2;
								}
							} else {
								row1.ubigeo = null;
							}
						...
						if (colQtyInRs_tDBInput_2 < 14) {
							row1.tipoDocumento = null;
						} else {

							if (rs_tDBInput_2.getObject(14) != null) {
								row1.tipoDocumento = rs_tDBInput_2.getInt(14);
							} else {
								row1.tipoDocumento = null;
							}
						}
						if (colQtyInRs_tDBInput_2 < 15) {
							row1.apellidoPaterno = null;
						} else {
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2
										.contains(rsmd_tDBInput_2
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row1.apellidoPaterno = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row1.apellidoPaterno = tmpContent_tDBInput_2;
								}
							} else {
								row1.apellidoPaterno = null;
							}
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2
										.contains(rsmd_tDBInput_2
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row1.apellidoMaterno = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row1.apellidoMaterno = tmpContent_tDBInput_2;
								}
							} else {
								row1.apellidoMaterno = null;
							}
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2
										.contains(rsmd_tDBInput_2
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row1.nombre = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row1.nombre = tmpContent_tDBInput_2;
								}
							} else {
								row1.nombre = null;
							}
						...
						if (colQtyInRs_tDBInput_2 < 18) {
							...
							if (rs_tDBInput_2.getObject(18) != null) {
								row1.canalId = rs_tDBInput_2.getInt(18);
							} else {
								row1.canalId = null;
							}
						}
						...
						{ // start of Var scope
							...
							// # Output table : 'salida'
							salida_tmp.persona = row1.persona;
							salida_tmp.codigo = row1.codigo;
							salida_tmp.razonSocial = row1.razonSocial;
							salida_tmp.direccion = row1.direccion;
							salida_tmp.rucDni = row1.rucDni;
							salida_tmp.telefono1 = row1.telefono1;
							salida_tmp.telefono2 = row1.telefono2;
							salida_tmp.monedaLinea = row1.monedaLinea;
							salida_tmp.lineaCredito = row1.lineaCredito;
							salida_tmp.codigoAuxiliar = row1.codigoAuxiliar;
							salida_tmp.estado = row1.estado;
							salida_tmp.departamento = row1.departamento;
							salida_tmp.ubigeo = row1.ubigeo;
							salida_tmp.tipoDocumento = row1.tipoDocumento;
							salida_tmp.apellidoPaterno = row1.apellidoPaterno;
							salida_tmp.apellidoMaterno = row1.apellidoMaterno;
							salida_tmp.nombre = row1.nombre;
							salida_tmp.canalId = row1.canalId;
							salida = salida_tmp;
							// ###############################
						...
						if (salida != null) {
							...
							if (execStat) {
								runStat.updateStatOnConnection("salida"
										+ iterateId, 1, 1);
							}

							whetherReject_tDBOutput_3 = false;
							pstmt_tDBOutput_3.setInt(1, salida.persona);

							if (salida.codigo == null) {
								pstmt_tDBOutput_3.setNull(2,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_3.setString(2, salida.codigo);
							}
							...
							if (salida.direccion == null) {
								pstmt_tDBOutput_3.setNull(4,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_3
										.setString(4, salida.direccion);
							}

							if (salida.rucDni == null) {
								pstmt_tDBOutput_3.setNull(5,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_3.setInt(5, salida.rucDni);
							}

							if (salida.telefono1 == null) {
								pstmt_tDBOutput_3.setNull(6,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_3.setInt(6, salida.telefono1);
							}

							if (salida.telefono2 == null) {
								pstmt_tDBOutput_3.setNull(7,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_3.setInt(7, salida.telefono2);
							}

							if (salida.monedaLinea == null) {
								pstmt_tDBOutput_3.setNull(8,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_3.setInt(8, salida.monedaLinea);
							}

							pstmt_tDBOutput_3.setBigDecimal(9,
									salida.lineaCredito);

							if (salida.codigoAuxiliar == null) {
								pstmt_tDBOutput_3.setNull(10,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_3.setString(10,
										salida.codigoAuxiliar);
							}
							...
							if (salida.estado == null) {
								...
								pstmt_tDBOutput_3.setInt(11, salida.estado);
							}

							if (salida.departamento == null) {
							...
							if (salida.ubigeo == null) {
								pstmt_tDBOutput_3.setNull(13,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_3.setString(13, salida.ubigeo);
							}

							if (salida.tipoDocumento == null) {
								pstmt_tDBOutput_3.setNull(14,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_3.setInt(14,
										salida.tipoDocumento);
							}

							if (salida.apellidoPaterno == null) {
								pstmt_tDBOutput_3.setNull(15,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_3.setString(15,
										salida.apellidoPaterno);
							}

							if (salida.apellidoMaterno == null) {
								pstmt_tDBOutput_3.setNull(16,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_3.setString(16,
										salida.apellidoMaterno);
							}
							...
							if (salida.nombre == null) {
								...
								pstmt_tDBOutput_3.setString(17, salida.nombre);
							}

							if (salida.canalId == null) {
								pstmt_tDBOutput_3.setNull(18,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_3.setInt(18, salida.canalId);
							}
	...
	public static void main(String[] args) {
		final carga_mysql carga_mysqlClass = new carga_mysql();

		int exitCode = carga_mysqlClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = carga_mysql.class.getClassLoader()
					.getResourceAsStream(
							"proyecto_bi/carga_mysql_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = carga_mysql.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : carga_mysql");
		}
...
/************************************************************************************************
 * 74416 characters generated by Talend Open Studio for Data Integration on the
 * 20 de noviembre de 2018 05:54:49 PM COT
 ************************************************************************************************/
